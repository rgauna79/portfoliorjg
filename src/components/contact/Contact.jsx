    ...
    <section className="contact-main" id="contact">
      <div className="form-container">
        ...
        <form ref={refForm} onSubmit={handleSubmit} className="contact-form">
          <fieldset>
            <label htmlFor="name" className="symbol-required">
              Name:{" "}
            </label>
            <input
              type="text"
          ...
          <fieldset>
            <label htmlFor="email" className="symbol-required">
              Email:{" "}
            </label>
            <input
              type="email"
              name="email"
              id="email"
              placeholder="Ex. yourname@dom.com"
              required
            />
          </fieldset>
          <fieldset>
            <label htmlFor="message" className="symbol-required">
              Message
            </label>
            <textarea
              maxLength="500"
          ...
          <button type="submit" value="" id="submit-contact" className="btn">
            Submit
          </button>
        </form>
      </div>
